...
This is not a test! It is expected that you often don't know how to start, make a lot of mistakes and need help. It is expected that you are familiar with independent study content before the workshop.
...
Last session we created data by typing the values in to
R. This is not practical when you have a lot of data. 
