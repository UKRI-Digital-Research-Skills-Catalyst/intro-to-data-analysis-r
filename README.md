...
This repository contains all materials for a half-day workshop called
"Introduction to Reproducibility with R".
...
Materials are organised as Quarto (`.qmd`) website: [Introduction to
Reproducibility with
R](https://3mmarand.github.io/setac-13-intro-to-r/).
...
-   These R packages from CRAN: **`tidyverse`**, **`devtools`**. Once
    you have installed R and RStudio, start RStudio up and go to the
...
-   TinyTeX: Once you have installed R and RStudio, start RStudio up and
...
3.  Reproducible data reports with Quarto
...
Please cite these materials if you adapt or redistribute any portion of
of them:
